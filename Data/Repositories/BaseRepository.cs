...
public abstract class BaseRepository<TEntity>(CustomerDbContext context) : IBaseRepository<TEntity> where TEntity : class
{
    protected readonly CustomerDbContext _context = context;
